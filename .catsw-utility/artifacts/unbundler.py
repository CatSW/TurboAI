...
# Created 2026-08-17
# unbundler.py
# Extracts files from a ContextBundler context-out-*.md (BundleFormatVersion 3
# or legacy "## File:" format). Auto-detects whole-file base64 (ContextBundler --base64).
...
def main() -> None:
    # Script lives in .catsw-utility/artifacts/ → utility root is parent
