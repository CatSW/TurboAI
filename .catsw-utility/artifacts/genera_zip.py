...
# Created 2026-08-17
# genera_zip.py
# 1) UnBundler del context-out-*.md presente in .catsw-utility/
# 2) Crea FromLlm-<descrizione>.zip in .catsw-utility/output/ (no container dir)
# 3) Rimuove i file sciolti di estrazione
...
def main() -> None:
    ...
    utility_root = script_dir.parent  # .catsw-utility
